...
1. L'utilisateur lance une session d’entraînement.
2. L’application génère une note aléatoire (ex : La, Si, Do…).
3. Le téléphone joue la note via le haut-parleur.
4. L’utilisateur rejoue cette note sur sa guitare.
5. Le micro enregistre et analyse la fréquence émise.
6. **Résultat :**
   - 👍 Si la note jouée est correcte → étape suivante  
   - 👎 Sinon → l’application indique une erreur et l’utilisateur réessaie
7. À la fin d’une série, l’application propose un score ou un récapitulatif.
